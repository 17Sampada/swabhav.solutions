        ...
        public static ISession CreateSession()
        {
            if (_sessionFactor == null)
            {
                _sessionFactor = Fluently.Configure()
                    .Database(MsSqlConfiguration.MsSql2012.ConnectionString("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=PasswordHashing;Integrated Security=True;Connect Timeout=30;Encrypt=False"))
